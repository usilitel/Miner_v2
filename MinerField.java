...
// игровое поле дл€ игры "—апер"
// данный класс расшир€етс€ внутри класса MinerLogic дл€ реализации логики отрисовки €чеек
public class MinerField  extends JPanel{

    private int BLOCK_SIZE; // размер блока в пиксел€х
    ...
    //------------------------
    // методы дл€ отрисовки разных типов €чеек
